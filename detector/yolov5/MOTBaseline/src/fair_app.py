...
def create_detections(detection_mat, frame_idx, min_height=0):
    ...
    for row in detection_mat[mask]:
        ...
        if bbox[3] < min_height:
            continue
        detection_list.append(Detections(bbox, confidence, feature))
...
# 视频帧的路径
# args.sequence_dir='/mnt/c/Users/83725/Desktop/AIC21-MTMC/datasets/detection/images/test/S06/c041'
# 特征向量的路径
# args.detection_file='/mnt/c/Users/83725/Desktop/AIC21-MTMC/datasets/detect_merge/c041/c041_dets_feat.pkl'
# mot结果的保存路径
# args.output_file='/mnt/c/Users/83725/Desktop/AIC21-MTMC/datasets/detect_merge/c041/c041_mot.txt'

# --min_confidence=0.1 \
# --nms_max_overlap 0.99 \
# min_detection_height = 0(default)
# --max_cosine_distance 0.5
# --display=False \
# --max_frame_idx -1 \

# --min-box-area 750 \
# --cfg_file ${config} \     config_file="aic_all.yml"
# --seq_name ${seq} \        seq_name = "c041", seqs = ("c041" "c042" "c043" "c044" "c045" "c046")
