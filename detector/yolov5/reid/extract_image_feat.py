...
NUM_PROCESS = 1
def chunks(img_list):
    return [img_list[i:i+BATCH_SIZE] for i in range(0, len(img_list), BATCH_SIZE)]

# DET_SOURCE_DIR: '/mnt/c/Users/83725/Desktop/AIC21-MTMC/datasets/detection/images/test/S06/'
# REID_MODEL: 'reid_model/resnet101_ibn_a_2.pth'
# REID_BACKBONE: 'resnet101_ibn_a'
# DET_IMG_DIR: '/mnt/c/Users/83725/Desktop/AIC21-MTMC/datasets/detect_merge/'
# DATA_DIR: '/mnt/c/Users/83725/Desktop/AIC21-MTMC/datasets/detect_reid1/'
